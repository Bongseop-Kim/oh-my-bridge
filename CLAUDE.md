...
Claude가 코드 생성 작업을 자율 판단하여 Codex CLI(MCP)에 위임하는 skill 기반 브리지 플러그인 (v2.0.2).
...
# 캐시 직접 동기화 (버전 업 전 급할 때, 현재 버전: 2.0.2)
cp skills/code-routing.md ~/.claude/plugins/cache/oh-my-bridge/oh-my-bridge/2.0.2/skills/code-routing.md
